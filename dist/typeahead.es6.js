...
var TypeaheadOption = (function (_super) {
    ...
    TypeaheadOption.prototype.render = function () {
        ...
        return (createElement("li", { className: classList, onClick: this.onClick, onMouseDown: this.onClick },
            createElement("a", { href: "javascript: void 0;", className: this.getClasses() }, children)));
    };
...
var TypeaheadSelector = (function (_super) {
    ...
    TypeaheadSelector.prototype.render = function () {
        ...
        if (customValue) {
            customValueOffset += 1;
            customValueComponent = (createElement(TypeaheadOption, { key: customValue, hover: selectionIndex === 0, customClasses: customClasses, customValue: customValue, onClick: this.onClick.bind(this, customValue) }, customValue));
        }
        var results = options.map(function (result, i) {
            var displayString = displayOption(result, i);
            var uniqueKey = displayString + '_' + i;
            return (createElement(TypeaheadOption, { key: uniqueKey, hover: selectionIndex === i + customValueOffset, customClasses: customClasses, onClick: _this.onClick.bind(_this, result) }, displayString));
        });
...
var Typeahead = (function (_super) {
    ...
    Typeahead.prototype.renderIncrementalSearchResults = function () {
        ...
        return (createElement(TypeaheadSelector, __assign({ options: maxVisible ? searchResults.slice(0, maxVisible) : searchResults, areResultsTruncated: truncated, onOptionSelected: this.onOptionSelected, customValue: this.getCustomValue(), displayOption: Accessor.generateOptionToStringFor(displayOption) }, {
...
//# sourceMappingURL=typeahead.es6.js.map
