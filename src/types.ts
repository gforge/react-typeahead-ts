...
export type SelectorOptionSelector<Opt extends Option> =
  (result: Opt, event: React.MouseEvent<HTMLLIElement>) => any;
...
export type OptionToStrFn<T extends OptionsObject> = (option: T, index?: number) => string;

export type SelectorType<T extends Option> = T extends string ? string : OptionToStrFn<OptionsObject>;
